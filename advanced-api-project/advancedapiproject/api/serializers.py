...
class AuthorSerializer(serializers.ModelSerializer):
    # This nests the BookSerializer inside AuthorSerializer to show related books
    ...
    # The relationship: An Author has many Books. We use BookSerializer to show them.
